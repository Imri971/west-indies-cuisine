 ...
 */
final class Version20191010123002 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comments (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, recipe_id INTEGER DEFAULT NULL, user_id INTEGER DEFAULT NULL, author VARCHAR(30) NOT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY, picture VARCHAR(255) DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, email VARCHAR(255) DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_5F9E962A59D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_5F9E962AA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, user_id, title, image, preparation_time, price_range, difficulty_level, description, created_at FROM recipe');
        ...
        $this->addSql('INSERT INTO recipe (id, user_id, title, image, preparation_time, price_range, difficulty_level, description, created_at) SELECT id, user_id, title, image, preparation_time, price_range, difficulty_level, description, created_at FROM __temp__recipe');
        ...
        $this->addSql('DROP INDEX IDX_D3781A6CA76ED395');
        $this->addSql('DROP INDEX IDX_D3781A6CFDF2B1FA');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_like AS SELECT id, user_id, recipes_id, created_at FROM recipe_like');
        $this->addSql('DROP TABLE recipe_like');
        $this->addSql('CREATE TABLE recipe_like (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, recipes_id INTEGER DEFAULT NULL, created_at DATETIME DEFAULT NULL, CONSTRAINT FK_D3781A6CA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_D3781A6CFDF2B1FA FOREIGN KEY (recipes_id) REFERENCES recipe (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO recipe_like (id, user_id, recipes_id, created_at) SELECT id, user_id, recipes_id, created_at FROM __temp__recipe_like');
        $this->addSql('DROP TABLE __temp__recipe_like');
        $this->addSql('CREATE INDEX IDX_D3781A6CA76ED395 ON recipe_like (user_id)');
        $this->addSql('CREATE INDEX IDX_D3781A6CFDF2B1FA ON recipe_like (recipes_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, user_id, title, image, preparation_time, price_range, difficulty_level, description, created_at FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(130) NOT NULL, image VARCHAR(255) NOT NULL, preparation_time INTEGER NOT NULL, price_range INTEGER NOT NULL, difficulty_level INTEGER NOT NULL, description CLOB DEFAULT NULL, created_at DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO recipe (id, user_id, title, image, preparation_time, price_range, difficulty_level, description, created_at) SELECT id, user_id, title, image, preparation_time, price_range, difficulty_level, description, created_at FROM __temp__recipe');
        $this->addSql('DROP TABLE __temp__recipe');
        $this->addSql('CREATE INDEX IDX_DA88B137A76ED395 ON recipe (user_id)');
        $this->addSql('DROP INDEX IDX_22D1FE1359D8A214');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_like AS SELECT id, user_id, recipes_id, created_at FROM recipe_like');
        $this->addSql('DROP TABLE recipe_like');
        $this->addSql('CREATE TABLE recipe_like (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, recipes_id INTEGER DEFAULT NULL, created_at DATETIME DEFAULT NULL)');
        $this->addSql('INSERT INTO recipe_like (id, user_id, recipes_id, created_at) SELECT id, user_id, recipes_id, created_at FROM __temp__recipe_like');
        $this->addSql('DROP TABLE __temp__recipe_like');
        $this->addSql('CREATE INDEX IDX_D3781A6CA76ED395 ON recipe_like (user_id)');
        $this->addSql('CREATE INDEX IDX_D3781A6CFDF2B1FA ON recipe_like (recipes_id)');
