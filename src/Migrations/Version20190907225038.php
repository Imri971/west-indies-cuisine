 ...
 */
final class Version20190907225038 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE kitchen_tools ADD COLUMN picture VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_82EABCC5933FE08C ON ingredient_unit (ingredient_id)');
        $this->addSql('CREATE INDEX IDX_82EABCC5F8BD700D ON ingredient_unit (unit_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__kitchen_tools AS SELECT id, name FROM kitchen_tools');
        ...
        $this->addSql('INSERT INTO kitchen_tools (id, name) SELECT id, name FROM __temp__kitchen_tools');
        $this->addSql('DROP TABLE __temp__kitchen_tools');
        $this->addSql('DROP INDEX IDX_22D1FE1359D8A214');
        $this->addSql('DROP INDEX IDX_22D1FE13933FE08C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_ingredient AS SELECT recipe_id, ingredient_id FROM recipe_ingredient');
        $this->addSql('DROP TABLE recipe_ingredient');
