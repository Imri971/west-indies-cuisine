 ...
 */
final class Version20191004184801 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_D3781A6C59D8A214');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_like AS SELECT id, recipe_id, user_id, created_at FROM recipe_like');
        ...
        $this->addSql('INSERT INTO recipe_like (id, recipes_id, user_id, created_at) SELECT id, recipe_id, user_id, created_at FROM __temp__recipe_like');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE recipe_like');
        $this->addSql('CREATE TABLE recipe_like (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, created_at DATETIME DEFAULT NULL, recipe_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO recipe_like (id, user_id, recipe_id, created_at) SELECT id, user_id, recipes_id, created_at FROM __temp__recipe_like');
        $this->addSql('DROP TABLE __temp__recipe_like');
        $this->addSql('CREATE INDEX IDX_D3781A6CA76ED395 ON recipe_like (user_id)');
        $this->addSql('CREATE INDEX IDX_D3781A6C59D8A214 ON recipe_like (recipe_id)');
        $this->addSql('DROP INDEX IDX_72DED3CF59D8A214');
        $this->addSql('DROP INDEX IDX_72DED3CFBAD26311');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_tag AS SELECT recipe_id, tag_id FROM recipe_tag');
        $this->addSql('DROP TABLE recipe_tag');
