 ...
 */
final class Version20190930221921 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recipe_search ADD COLUMN price_range INTEGER DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_C252D4B159D8A214 ON recipe_kitchen_tools (recipe_id)');
        $this->addSql('CREATE INDEX IDX_C252D4B186813830 ON recipe_kitchen_tools (kitchen_tools_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_search AS SELECT id, title, tags, preparation_time, difficulty_level, ingredients FROM recipe_search');
        ...
        $this->addSql('INSERT INTO recipe_search (id, title, tags, preparation_time, difficulty_level, ingredients) SELECT id, title, tags, preparation_time, difficulty_level, ingredients FROM __temp__recipe_search');
        $this->addSql('DROP TABLE __temp__recipe_search');
        $this->addSql('DROP INDEX IDX_72DED3CF59D8A214');
        $this->addSql('DROP INDEX IDX_72DED3CFBAD26311');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_tag AS SELECT recipe_id, tag_id FROM recipe_tag');
        $this->addSql('DROP TABLE recipe_tag');
