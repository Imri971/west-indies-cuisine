 ...
 */
final class Version20190908004534 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE email (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comments AS SELECT id, recipe_id, author, content, picture, created_at FROM comments');
        $this->addSql('DROP TABLE comments');
        $this->addSql('CREATE TABLE comments (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, recipe_id INTEGER DEFAULT NULL, author VARCHAR(30) NOT NULL COLLATE BINARY, content CLOB NOT NULL COLLATE BINARY, picture VARCHAR(255) DEFAULT NULL COLLATE BINARY, created_at DATETIME NOT NULL, email VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_5F9E962A59D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO comments (id, recipe_id, author, content, picture, created_at) SELECT id, recipe_id, author, content, picture, created_at FROM __temp__comments');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__comments AS SELECT id, recipe_id, author, content, picture, created_at FROM comments');
        $this->addSql('DROP TABLE comments');
        $this->addSql('CREATE TABLE comments (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, recipe_id INTEGER DEFAULT NULL, author VARCHAR(30) NOT NULL, content CLOB NOT NULL, picture VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL)');
        $this->addSql('INSERT INTO comments (id, recipe_id, author, content, picture, created_at) SELECT id, recipe_id, author, content, picture, created_at FROM __temp__comments');
        $this->addSql('DROP TABLE __temp__comments');
        $this->addSql('CREATE INDEX IDX_5F9E962A59D8A214 ON comments (recipe_id)');
        $this->addSql('DROP INDEX IDX_82EABCC5933FE08C');
