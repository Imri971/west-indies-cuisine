 ...
 */
final class Version20191005210138 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_DA88B1378D7B4FB4');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, title, image, preparation_time, price_range, difficulty_level, description FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(130) NOT NULL COLLATE BINARY, image VARCHAR(255) NOT NULL COLLATE BINARY, preparation_time INTEGER NOT NULL, price_range INTEGER NOT NULL, difficulty_level INTEGER NOT NULL, description CLOB DEFAULT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO recipe (id, title, image, preparation_time, price_range, difficulty_level, description) SELECT id, title, image, preparation_time, price_range, difficulty_level, description FROM __temp__recipe');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe AS SELECT id, title, image, preparation_time, price_range, difficulty_level, description FROM recipe');
        $this->addSql('DROP TABLE recipe');
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, title VARCHAR(130) NOT NULL, image VARCHAR(255) NOT NULL, preparation_time INTEGER NOT NULL, price_range INTEGER NOT NULL, difficulty_level INTEGER NOT NULL, description CLOB DEFAULT NULL, tags_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO recipe (id, title, image, preparation_time, price_range, difficulty_level, description) SELECT id, title, image, preparation_time, price_range, difficulty_level, description FROM __temp__recipe');
        $this->addSql('DROP TABLE __temp__recipe');
        $this->addSql('CREATE INDEX IDX_DA88B1378D7B4FB4 ON recipe (tags_id)');
        $this->addSql('DROP INDEX IDX_22D1FE1359D8A214');
        $this->addSql('DROP INDEX IDX_22D1FE13933FE08C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__recipe_ingredient AS SELECT recipe_id, ingredient_id FROM recipe_ingredient');
        $this->addSql('DROP TABLE recipe_ingredient');
