 ...
 */
final class Version20191005205917 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE recipe (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, tags_id INTEGER DEFAULT NULL, title VARCHAR(130) NOT NULL COLLATE BINARY, image VARCHAR(255) NOT NULL COLLATE BINARY, preparation_time INTEGER NOT NULL, price_range INTEGER NOT NULL, difficulty_level INTEGER NOT NULL, description CLOB DEFAULT NULL COLLATE BINARY, CONSTRAINT FK_DA88B1378D7B4FB4 FOREIGN KEY (tags_id) REFERENCES tag (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
