 ...
 */
final class Version20191007160219 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__steps AS SELECT id, spot, description FROM steps');
        ...
        $this->addSql('INSERT INTO steps (id, spot, description) SELECT id, spot, description FROM __temp__steps');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__steps AS SELECT id, spot, description FROM steps');
        $this->addSql('DROP TABLE steps');
        $this->addSql('CREATE TABLE steps (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, spot INTEGER NOT NULL, description CLOB NOT NULL)');
        $this->addSql('INSERT INTO steps (id, spot, description) SELECT id, spot, description FROM __temp__steps');
        $this->addSql('DROP TABLE __temp__steps');
    }
}
